...
source file location: https://catalog.data.gov/dataset and find the dataset titled NYPD Shooting Incident Data (Historic). 
...
```
By grouping the data by perpetrator's race, 72.6% of them are black. This seems overwhelming high. To prove such hypothesis, we need to combine it with city's ethnic composition data, or even compare with other major city's crime data to find out whether this high percentage is valid or biased.
